...
/// demanda ainda nao tem proposta aceita.
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Prestador #${c.prestadorId}',
                          style:
                              const TextStyle(fontWeight: FontWeight.bold)),
                      Text('Enviada em ${Fmt.dataHora(c.criadoEm)}',
                          style: TextStyle(
            ...
            if (podeAceitar && c.status == StatusCandidatura.pendente) ...[
              ...
              SizedBox(
                ...
                child: FilledButton.icon(
                  ...
                  label: Text(aceitando ? 'Aceitando...' : 'Aceitar proposta'),
                ),
              ),
            ],
          ],
